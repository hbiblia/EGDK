...
void system_PadIA(GArray *entitys, const char *name)
{
    StartSystem
    {
        GetActorWithTag(entitys, "pelota");
        {
...
int main(int argc, char *argv[])
{
    ...
    ermine_system(OnSystemUpdate, "PadIA", system_PadIA);

    ermine_stage_init("Ermine - Pong", 800, 600, argv);
    {
        resource_load_sound("hit", "Content/Sound/hit.wav");
        resource_load_sound("hitHurt", "Content/Sound/hitHurt.wav");
